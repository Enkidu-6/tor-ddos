...
However relays running two instances of Tor have a higher chance of getting caught in the block list.  **remove-dual-or.sh** will remove only those relays from your block list.
