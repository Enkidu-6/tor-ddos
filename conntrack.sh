...
clear
echo -e "\033[1;32mYour system does not come with nf_conntrack. Please install conntrack utilities\nif you don't already have it. 'apt install conntrack' and use conntrack-2.sh\033[0m"
exit 1
...
echo -e "\033[1;37m There are \033[1;36m`cat 8 | wc -l`\033[1;37m IPs" 
...
echo -e "\033[1;37m There are \033[1;36m`cat 6 | wc -l`\033[1;37m IPs"
...
echo -e "\033[1;37m There are \033[1;36m`cat 7 | wc -l`\033[1;37m IPs"
