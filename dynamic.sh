...
# you have more than one IPV4 and one IPV6 associated with your NIC.
# List your current IP Addresses and your listening port in forms of 10.1.1.1:443 and [abcd:abcd::abcd]:443 
# one line at a time in ipv4.txt and ipv6.txt respectively. Put your ethernet port's name in nic.txt 
